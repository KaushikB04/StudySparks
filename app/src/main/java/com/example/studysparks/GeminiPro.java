...
public class GeminiPro {
    public void  getResponce(String query, ResposeCallback callback)
    {
        ...
        Futures.addCallback(response, new FutureCallback<GenerateContentResponse>() {
            ...
            public void onSuccess(GenerateContentResponse result) {
                ...
                callback.onResponce(resultText);
            }
    ...
    private GenerativeModelFutures getModel()
    {
        ...
        GenerativeModel gm = new GenerativeModel("gemini-pro",apikey,gC, Collections.singletonList(h));
